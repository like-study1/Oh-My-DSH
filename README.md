...
<!-- OMD:stats:START -->
截至 2026-08-16 10:09（北京时间），本目录收录精选插件 **1221** 个，监测生态仓库 **1587** 个，累计获得 Star **404082**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 116387 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 86965 | 渠道 | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Desig… |
| 3 | [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) | 40385 | 插件 | A one-of-a-kind resume builder that keeps your privacy in mind. Com… |
| 4 | [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) | 22498 | 项目 | 「同事」Skill：将离别化为温暖的数字生命 1.0 |
...
| 9 | [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 6087 | 工具 | 为 DeepSeek Harness (DSH) 生态打造的现代化桌面端体验 |
| 10 | [Q00/ouroboros](https://github.com/Q00/ouroboros) | 5425 | 插件 | Agent OS: the agent gets smarter on its own. We just hold the line:… |

### 分类构成

`消息通讯 136` · `视觉与多模态 78` · `浏览器与网络 72` · `Web UI 增强 291` · `皮肤与娱乐 101` · `Agent 能力 324` · `编码开发 89` · `文件与数据 35` · `开发工具与教程 45` · `精选合集与发行版 28` · `生态项目 22`
