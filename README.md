...
<!-- OMD:stats:START -->
截至 2026-08-15 22:01（北京时间），本目录收录精选插件 **1107** 个，监测生态仓库 **1518** 个，累计获得 Star **300870**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 109561 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 86744 | 渠道 | 🎨 The open-source Claude Design alternative. 🖥️ Local-first desktop… |
| 3 | [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) | 22336 | 项目 | 「同事」Skill：将离别化为温暖的数字生命 1.0 |
| 4 | [tt-a1i/archify](https://github.com/tt-a1i/archify) | 12850 | 插件 | Agent skill for beautiful, verifiable architecture, workflow, seque… |
...
| 6 | [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 4690 | 工具 | 为 DeepSeek Harness (DSH) 生态打造的现代化桌面端体验 |
...
| 10 | [foryourhealth111-pixel/Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 2804 | 技能 | VibeSkills is a general-purpose Skill that automatically routes loc… |

### 分类构成

`消息通讯 125` · `视觉与多模态 69` · `浏览器与网络 66` · `Web UI 增强 261` · `皮肤与娱乐 95` · `Agent 能力 292` · `编码开发 82` · `文件与数据 33` · `开发工具与教程 35` · `精选合集与发行版 28` · `生态项目 21`
