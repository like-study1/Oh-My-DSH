...
<!-- OMD:stats:START -->
截至 2026-08-25 09:52（北京时间），本目录收录精选插件 **2018** 个，监测生态仓库 **2000** 个，累计获得 Star **851013**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 192190 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 91111 | 渠道 | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Desig… |
| 3 | [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 69304 | 插件 | 🌊 The original agent meta-harness. Deploy intelligent multi-player … |
| 4 | [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) | 41661 | 插件 | A one-of-a-kind resume builder that keeps your privacy in mind. Com… |
| 5 | [esengine/DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) | 35123 | 插件 | DeepSeek-native AI coding agent for your terminal. Engineered aroun… |
| 6 | [volcengine/OpenViking](https://github.com/volcengine/OpenViking) | 32998 | 插件 | Self-evolving Context Database for AI Agents. Unify Agent Memory, K… |
| 7 | [Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) | 27037 | 插件 | :rocket: The Ultimate Image Uploader for Efficient Creators. Suppor… |
| 8 | [titanwings/distilly](https://github.com/titanwings/distilly) | 23921 | 项目 | 「同事」Skill：将离别化为温暖的数字生命 1.0 |
| 9 | [nocobase/nocobase](https://github.com/nocobase/nocobase) | 23821 | 插件 | NocoBase is an open-source AI + no-code platform for building busin… |
| 10 | [Tencent/WeKnora](https://github.com/Tencent/WeKnora) | 20538 | 插件 | Open-source LLM knowledge platform: turn raw documents into a query… |

### 分类构成

`消息通讯 231` · `视觉与多模态 125` · `浏览器与网络 121` · `Web UI 增强 484` · `皮肤与娱乐 157` · `Agent 能力 546` · `编码开发 155` · `文件与数据 62` · `开发工具与教程 82` · `精选合集与发行版 29` · `生态项目 26`
