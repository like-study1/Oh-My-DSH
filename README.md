...
<!-- OMD:stats:START -->
截至 2026-09-06 23:28（北京时间），本目录收录精选插件 **2121** 个，监测生态仓库 **2000** 个，累计获得 Star **992673**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 213818 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 94406 | 渠道 | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Desig… |
| 3 | [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 70866 | 插件 | 🌊 The original agent meta-harness. Deploy intelligent multi-player … |
| 4 | [tt-a1i/archify](https://github.com/tt-a1i/archify) | 50386 | 插件 | Agent skill for beautiful, verifiable architecture, workflow, seque… |
| 5 | [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) | 42247 | 插件 | A one-of-a-kind resume builder that keeps your privacy in mind. Com… |
| 6 | [volcengine/OpenViking](https://github.com/volcengine/OpenViking) | 35755 | 插件 | Self-evolving Context Database for AI Agents. Unify Agent Memory, K… |
| 7 | [esengine/DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) | 35418 | 插件 | DeepSeek-native AI coding agent for your terminal. Engineered aroun… |
| 8 | [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2) | 28266 | 插件 | Prompt as Code \| GPT-Image2 工业级提示词引擎与模板库，530+ 个案例逆向工程，20+ 套工业级模板，并… |
| 9 | [Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) | 27150 | 插件 | :rocket: The Ultimate Image Uploader for Efficient Creators. Suppor… |
| 10 | [titanwings/distilly](https://github.com/titanwings/distilly) | 24386 | 项目 | 「同事」Skill：将离别化为温暖的数字生命 1.0 |

### 分类构成

`消息通讯 246` · `视觉与多模态 132` · `浏览器与网络 147` · `Web UI 增强 495` · `皮肤与娱乐 159` · `Agent 能力 592` · `编码开发 148` · `文件与数据 59` · `开发工具与教程 87` · `精选合集与发行版 29` · `生态项目 27`
