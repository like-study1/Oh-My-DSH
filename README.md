...
<!-- OMD:stats:START -->
截至 2026-08-16 10:14（北京时间），本目录收录精选插件 **1223** 个，监测生态仓库 **1598** 个，累计获得 Star **404216**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 116458 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 86969 | 渠道 | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Desig… |
| 3 | [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) | 40386 | 插件 | A one-of-a-kind resume builder that keeps your privacy in mind. Com… |
| 4 | [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) | 22499 | 项目 | 「同事」Skill：将离别化为温暖的数字生命 1.0 |
| 5 | [Nagi-ovo/voyager](https://github.com/Nagi-ovo/voyager) | 19393 | 插件 | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a … |
| 6 | [tt-a1i/archify](https://github.com/tt-a1i/archify) | 12982 | 插件 | Agent skill for beautiful, verifiable architecture, workflow, seque… |
| 7 | [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2) | 10325 | 插件 | Prompt as Code \| GPT-Image2 工业级提示词引擎与模板库，470+ 个案例逆向工程，20+ 套工业级模板，并… |
| 8 | [YaoApp/yao](https://github.com/YaoApp/yao) | 7575 | 插件 | ✨ All your agents and workspaces in one place, on every device you … |
| 9 | [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 6103 | 工具 | 为 DeepSeek Harness (DSH) 生态打造的现代化桌面端体验 |
| 10 | [Q00/ouroboros](https://github.com/Q00/ouroboros) | 5425 | 插件 | Agent OS: the agent gets smarter on its own. We just hold the line:… |

### 分类构成

`消息通讯 136` · `视觉与多模态 79` · `浏览器与网络 72` · `Web UI 增强 292` · `皮肤与娱乐 101` · `Agent 能力 324` · `编码开发 89` · `文件与数据 35` · `开发工具与教程 45` · `精选合集与发行版 28` · `生态项目 22`
