...
<!-- OMD:stats:START -->
截至 2026-08-20 12:53（北京时间），本目录收录精选插件 **1874** 个，监测生态仓库 **2000** 个，累计获得 Star **633483**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 169063 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 89420 | 渠道 | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Desig… |
| 3 | [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) | 41201 | 插件 | A one-of-a-kind resume builder that keeps your privacy in mind. Com… |
| 4 | [esengine/DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) | 34886 | 插件 | DeepSeek-native AI coding agent for your terminal. Engineered aroun… |
| 5 | [volcengine/OpenViking](https://github.com/volcengine/OpenViking) | 30419 | 插件 | Self-evolving Context Database for AI Agents. Unify Agent Memory, K… |
| 6 | [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) | 23565 | 项目 | 「同事」Skill：将离别化为温暖的数字生命 1.0 |
| 7 | [Nagi-ovo/voyager](https://github.com/Nagi-ovo/voyager) | 19704 | 插件 | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a … |
| 8 | [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 15568 | 工具 | 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。 |
| 9 | [tt-a1i/archify](https://github.com/tt-a1i/archify) | 14543 | 插件 | Agent skill for beautiful, verifiable architecture, workflow, seque… |
| 10 | [walkinglabs/learn-harness-engineering](https://github.com/walkinglabs/learn-harness-engineering) | 12785 | 教程 | Harness engineering beginner tutorial, from 0 to 1 |

### 分类构成

`消息通讯 221` · `视觉与多模态 120` · `浏览器与网络 121` · `Web UI 增强 445` · `皮肤与娱乐 151` · `Agent 能力 513` · `编码开发 128` · `文件与数据 49` · `开发工具与教程 72` · `精选合集与发行版 28` · `生态项目 26`
