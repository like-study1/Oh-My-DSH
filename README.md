...
<!-- OMD:stats:START -->
截至 2026-08-14 05:14（UTC），本目录收录精选插件 **319** 个，监测生态仓库 **999** 个，累计获得 Star **110559**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 69339 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) | 21515 | 项目 | 「同事」Skill：将离别化为温暖的数字生命 1.0 |
| 3 | [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) | 3744 | 项目 | 下一代开源 AI 工作台：自进化 Agent 运行时，集成 DSH 子代理 |
| 4 | [whiteguo233/OpenBiliClaw](https://github.com/whiteguo233/OpenBiliClaw) | 2136 | 项目 | 本地优先的跨平台 AI 内容发现 Agent：B站、小红书、抖音、YouTube、X、知乎、Reddit |
| 5 | [paean-ai/deeptide](https://github.com/paean-ai/deeptide) | 1037 | 项目 | DeepSeek 官方风格 Swift 原生 macOS 编程 Agent |
| 6 | [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 974 | 合集 | DSH Web UI 插件与皮肤合集：任务面板、Git 图、右侧面板、移动端 UI、宠物、实时 Token 统计、皮肤中心 |
| 7 | [nutshellai-tech/mobius](https://github.com/nutshellai-tech/mobius) | 936 | 项目 | 首个自进化开源 Agent OS：连接团队、AI Agent、设备与算力 |
| 8 | [liustack/modlens](https://github.com/liustack/modlens) | 885 | 插件 | DSH 首个视觉插件：纯文本模型的视觉桥梁 |
| 9 | [Anionex/agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 672 | 插件 | 为纯文本模型设计的视觉工具箱：多图理解、长截图 OCR、前端 UI 还原、GUI 自动化，可接入 Codex/Claude Code/… |
...
1. **主题登记** — 为插件仓库添加 `dsh-plugin` 主题标签，自动同步将在 8 小时内完成收录（Star 不低于 3 自动入选）。
