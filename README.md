...
<!-- OMD:stats:START -->
截至 2026-09-25 21:48（北京时间），本目录收录精选插件 **2139** 个，监测生态仓库 **2000** 个，累计获得 Star **1134725**。

### 精选插件十强

| 序号 | 插件 | Star | 类型 | 说明 |
|---|---|---|---|---|
| 1 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 235723 | 项目 | DeepSeek Harness 官方仓库：Everything is a Plugin. |
| 2 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 98055 | 渠道 | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Desig… |
| 3 | [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 73248 | 插件 | 🌊 The original agent harness. Deploy intelligent multi-player swarm… |
| 4 | [tt-a1i/archify](https://github.com/tt-a1i/archify) | 71493 | 插件 | Agent skill for beautiful, verifiable architecture, workflow, seque… |
| 5 | [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) | 43414 | 插件 | A one-of-a-kind resume builder that keeps your privacy in mind. Com… |
| 6 | [volcengine/OpenViking](https://github.com/volcengine/OpenViking) | 38659 | 插件 | Self-evolving Context Database for AI Agents. Unify Agent Memory, K… |
...
| 8 | [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2) | 33510 | 插件 | Prompt as Code \| GPT Image 2 / 2.5 提示词与案例库，530+ 个案例、20+ 套工业级模板与可复用… |
| 9 | [Tencent/WeKnora](https://github.com/Tencent/WeKnora) | 29928 | 插件 | Open-source LLM knowledge platform: turn raw documents into a query… |
| 10 | [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | 28958 | 工具 | 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。 |

### 分类构成

`消息通讯 228` · `视觉与多模态 126` · `浏览器与网络 134` · `Web UI 增强 512` · `皮肤与娱乐 152` · `Agent 能力 632` · `编码开发 138` · `文件与数据 59` · `开发工具与教程 104` · `精选合集与发行版 24` · `生态项目 30`
